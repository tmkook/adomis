...
export default class AdminControllerCommand extends BaseCommand {
  ...
  async run() {
    ...
    if (this.complete) {
      ...
      //create controller
      codemods.makeUsingStub(kmolaRoot, '/stubs/controllers/key_controller.stub', {
        model: this.model,
        dir: this.dir,
      ...
      //create lang
      codemods.makeUsingStub(kmolaRoot, '/stubs/lang/en.stub', {
        model: this.model,
        dir: this.dir,
        keys: Object.keys(keys),
      })
      ...
      codemods.makeUsingStub(kmolaRoot, '/stubs/schemas/crud_amis.stub', {
        model: this.model,
        dir: this.dir,
        api: api,
        column: column,
      ...
      codemods.makeUsingStub(kmolaRoot, '/stubs/controllers/api_controller.stub', {
        model: this.model,
        dir: this.dir,
      })
    }
